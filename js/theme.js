...
(function ($) {
  jQuery(document).ready(function () {
    ...
    $('.gal-photos [data-fancybox="gall"]').fancybox(); // Toggle on check button click
    //$(".car-row").hide();
    ...
    $(document).ready(function () {
      $(".blog-detailed--accordion .wrap > h4").on("click", function (e) {
        if ($(this).hasClass("active")) {
          $(this).removeClass("active");
          $(this).siblings(".blog-detailed--accordion .wrap > div").slideUp(200);
        } else {
          $(".blog-detailed--accordion .wrap > h4").removeClass("active");
          $(this).addClass("active");
          $(".blog-detailed--accordion .wrap > div").slideUp(200);
          $(this).siblings(".blog-detailed--accordion .wrap > div").slideDown(200);
        }
    ...
    $('.blog-content a').attr("target", "_blank"); // $(document).ready(function() {
    // 	var s = $("#side-nav");
    // 	var pos = s.position();					   
